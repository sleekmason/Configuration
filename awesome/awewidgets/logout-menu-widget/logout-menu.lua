...
local ICON_DIR = HOME .. '/.config/awesome/awewidgets/logout-menu-widget/icons/'

local logout_menu_widget = wibox.widget {
    {
        {
            image = ICON_DIR .. 'power_w2.svg',
            resize = true,
...
local function worker(user_args)
    ...
    local onlogout = args.onlogout or function () awful.spawn.with_shell("pkill -KILL -u $USER") end
